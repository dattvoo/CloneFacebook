...
export const DisplayAccessbility = ({ setVisible }) => {
  return (
    <div className="absolute_wrap">
      ...
      <div className="mmenu_main">
        ...
        <div className="mmenu_col">
          ...
          <span className="mmenu_span2">
            Adjust the appearance of Facebook to reduce glare and give your eye
            a break.
          </span>
        </div>
      </div>
      ...
      <div className="mmenu_main">
        ...
        <div className="mmenu_col">
          ...
          <span className="mmenu_span2">
            Make your font size smaller so mỏe content can fit on the screen
          </span>
        </div>
      </div>
      ...
      <label htmlFor="dcompactOn" className="hover1">
        <span>On</span>
